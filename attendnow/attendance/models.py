...
class User(AbstractBaseUser):
    ...
    smtp_password = models.CharField(max_length=100,default=None,null=True,blank=True)
    smtp_email = models.CharField(max_length=200,default=None,null=True,blank=True)
